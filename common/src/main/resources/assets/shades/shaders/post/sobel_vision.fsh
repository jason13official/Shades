...
/// direct port of 1.20.1's sobel.fsh: a 12-tap min-erosion across three ring sizes, leaving only
/// the darkest/highest-contrast edges lit and everything else black
void main() {
